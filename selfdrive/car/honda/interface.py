...
class CarInterface(CarInterfaceBase):
  ...
  def get_pid_accel_limits(CP, current_speed, cruise_speed):
    ...
    #ADDED 2024.02.10
      ...
      HONDAPILOT_PEDAL_MAX = interp(current_speed, [0, 2.2, 4.5, 6.7, 22.3, 44.7], [3.5, 3.0, 2.5, 1.6, 1.0, 1.0])
      return CarControllerParams.NIDEC_ACCEL_MIN, HONDAPILOT_PEDAL_MAX
    else:
